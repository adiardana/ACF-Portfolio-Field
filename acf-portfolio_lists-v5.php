...
class acf_field_portfolio_lists extends acf_field {
	...
	*/
	...
	function __construct() {
		...
		*/
		...
		$this->label = __('Portfolio Lists', 'acf-portfolio_lists');
		...
		*  var message = acf._e('portfolio_lists', 'error');
		*/

		$this->l10n = array(
			'error'	=> __('Error! Please enter a higher value', 'acf-portfolio_lists'),
		);
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		*/
		...
		// 	'label'			=> __('Font Size','acf-portfolio_lists'),
		// 	'instructions'	=> __('Customise the input font size','acf-portfolio_lists'),
		// 	'type'			=> 'number',
		// 	'name'			=> 'font_size',
		// 	'prepend'		=> 'px',
		// ));
...
/*
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		wp_register_script( 'acf-input-portfolio_lists', "{$dir}js/input.js" );
		wp_enqueue_script('acf-input-portfolio_lists');


		// register & include CSS
		wp_register_style( 'acf-input-portfolio_lists', "{$dir}css/input.css" );
		wp_enqueue_style('acf-input-portfolio_lists');
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','acf-portfolio_lists'),
		}
